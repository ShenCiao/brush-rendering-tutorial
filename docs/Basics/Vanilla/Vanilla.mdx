...
Modern tablets are stable enough to avoid generating the ill data.
But the corner case is common in 3D, I will introduce the solution together with 3D stroke rendering.
