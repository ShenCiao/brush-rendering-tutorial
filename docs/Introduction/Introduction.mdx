...
If there are bugs for common usages, tell me in the [issue](https://github.com/ShenCiao/brush-rendering-tutorial/issues) page.

:::

## Structure

Although the algorithms are very straightforward, I know how hard it could be to learn and reproduce a research work.
